...
export default function Dashboard() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-gray-800 text-white px-6 py-10 md:px-20">
            <div className="lg:flex-row flex flex-col  justify-between items-center mb-5">
                <h1 className="text-5xl font-extrabold text-emerald-400  select-none">
                    Crypto Trackr
                </h1>
                <div className="flex gap-5  text-lg font-semibold">
                    {["dashboard", "wallet", "alerts", "history", "dca", "download"].map((tab) => (
                        <button
                            key={tab}
                            onClick={() => {
                            ...
                            className={`hover:text-white capitalize ${activeTab === tab ? "text-emerald-400 underline" : "text-gray-400"
                                }`}
                        >
                            {tab === "dca"
                                ? "DCA Simulator"
            ...
            <p className="text-gray-400 mb-10 text-lg">Live prices ...........</p>
            ...
            {activeTab === "dashboard" && (
                <>
                    ...
                    {/* Portfolio Table */}
                    <div className="bg-gray-900/80 p-8 rounded-xl shadow-2xl border border-emerald-800/40">
                    ...
                    {selectedCoinChart && (
                        <div
                            ref={chartRef}
                            className="bg-gray-800 p-6 mt-10 rounded-lg"
                        >
            ...
            {activeTab === "alerts" && (
                <div className="my-10 bg-gray-900 p-6 rounded-lg shadow-lg">
            ...
            {activeTab === "history" && (
                <div className="bg-gray-900 p-6 rounded-lg">
                    <h2 className="text-xl font-bold text-emerald-300">Transaction History</h2>
